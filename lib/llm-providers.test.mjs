...
test("resolveLlmProviderConfigs drops direct providers without an API key", () => {
  const resolved = resolveLlmProviderConfigs(
    {
      llm_providers: "openai,google,mistral",
      openai_api_key: "openai-key",
      openai_model_name: "gpt-4o-mini",
      google_api_key: "",
      google_model_name: "gemini-2.5-flash",
...
test("resolveLlmProviderConfigs returns an empty list when nothing usable is configured", () => {
  const resolved = resolveLlmProviderConfigs(
    {
      llm_providers: "openai,google,mistral",
      openai_api_key: "",
